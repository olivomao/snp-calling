...
'''
usage:
python sim_data_generator.py --read_generation_at_sel_snps
                             -s snp_file
...
'''
def read_generation_at_sel_snps(args):
...
if __name__ == "__main__":
    ...
    elif '--read_generation_at_sel_snps' in args:
        read_generation_at_sel_snps(args)
