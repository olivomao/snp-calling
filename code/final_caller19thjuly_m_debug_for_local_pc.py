...
if __name__ == "__main__":
    ...
    tophat_dir = "data_GATK/2pass/" #'/tophat_out/'
    ...
    final_caller(tophat_dir + count_fn,
                 '/caller_output_altMap_cross_check_dedupped_debug_case2.txt',
                 '/caller_output_exception_altMap_cross_check_dedupped_debug_case2.txt',
                 '/caller_output_snp_found_altMap_cross_check_dedupped_debug_case2.txt')
